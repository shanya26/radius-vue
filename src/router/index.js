...
const DealersList = () => import('@/views/manage/DealersList')
const SubscribersList = () => import('@/views/manage/SubscribersList')
...
const NASManage = () => import('@/views/NAS/NASManage')

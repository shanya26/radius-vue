        ...
        <CCard> 
          <CCardBody>    
            <div class="my-1 mx-2 text-right plus-button">
              <CButton color="light" class="plus-icon" @click.prevent="showUserForm"><plusicon/></CButton>
            </div>
            <CDataTable
                    hover
                    striped
                  ...
                  > 
                    ...
                    <template #subscribercount="{item,index}"> 
                      <td>
                        <a class="active"><div @click.prevent="showSubscriber(item.sub)">{{item.subscribercount?item.subscribercount:0}}</div> </a>
                      </td>
                    </template> 
                  </CDataTable>
          </CCardBody>
...
import plusicon from "../../assets/icons/plusicon"
  export default {
    ...
    data: () => {
      return {
        ...
        fields: [ 
          ...
          { key: 'subscribercount','label':"No of subscriber" },
          {key:'action'}
        ],
        subscriberfields: [ 
          { key: 'username', label: 'User Name' },
    ...
    methods: {
      ...
      showUserForm(e){
        this.$router.push({ name: 'Manage User', params: {"action":'addUser',"group":'dealer'} })        
      },
      showSubscriber(sub){
